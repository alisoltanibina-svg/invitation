export const invitation = {
  ...
  letter:
    "با مهر و شوق، از شما دعوت می‌کنیم آغاز فصل تازه زندگی‌مان را در کنار ما جشن بگیرید.",
  storyTitle: "داستان عاشقانه‌ی ما، از این روز آغاز می‌شود",
  story:
    "تمام مسیرهای زندگی، ما را به این لحظه رساند؛ لحظه‌ای که با عشق، زندگی را آغاز می‌کنیم.",
